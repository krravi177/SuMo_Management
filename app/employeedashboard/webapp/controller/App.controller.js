sap.ui.define([
	...
	return Controller.extend("com.dash.employeedashboard.controller.App", {
		onInit: function () {
		...
		// 	if (this.currentRouteName === "view1") { // last viewed route was list
		// 		var oListView = this.oRouter.getView("com.dash.employeedashboard.view.View1");
		...
		// 	this.currentProjectId = oArguments.projectId;
		// },
		...
		// 			{layout: sLayout, projectid: this.currentProjectId, project: this.currentProject}, true);
		// 	}
		// },
