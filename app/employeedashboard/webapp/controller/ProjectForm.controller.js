    ...
    return Controller.extend("com.dash.employeedashboard.controller.ProjectForm", {
        ...
        onSubmitNewProjectFormAdmin: function () {
            ...
            var formData = {
                ...
                startDate: oView.byId("pStartDate").getDateValue() ? oView.byId("pStartDate").getDateValue().toISOString() : null, 
                endDate: oView.byId("pEndDate").getDateValue() ? oView.byId("pEndDate").getDateValue().toISOString() : null 
            };
