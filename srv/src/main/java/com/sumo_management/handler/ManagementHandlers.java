...
import cds.gen.managementservice.Employees;
import cds.gen.managementservice.Employees_;
import cds.gen.managementservice.Projects;
import cds.gen.managementservice.Projects_;
import cds.gen.managementservice.ManagementService_;
import cds.gen.managementservice.CreateProjectContext;
...
public class ManagementHandlers implements EventHandler {
    ...
    @After(event = "CREATE", entity = "ManagementService.Projects")
    public void createProject() {
        System.out.println("Custom handler executed successfully!");
    }
     ...
     */
    // @On(event ="CREATE" ,entity = Projects_.CDS_NAME)
    // public void createProject(@RequestParam String status,
