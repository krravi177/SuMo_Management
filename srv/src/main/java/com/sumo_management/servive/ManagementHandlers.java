...
public class ManagementHandlers implements EventHandler {
    ...
    // }
        ...
        @On(event = CqnService.EVENT_CREATE, entity = Projects_.CDS_NAME)
        public void createProject(CdsCreateEventContext context) {
    ...
    entries.forEach(entry -> {
        System.out.println("Project Created Successfully: " + entry.get("projectName"));
    });

    context.setResult(entries); // Ensure the response is set
} 
